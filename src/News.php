...
<div class="container my-8 mx-auto md:px-6">
    ...
    <section class="mb-32 text-center md:text-left">
      ...
      <div class="mb-6 flex flex-wrap" style="border-bottom-width: 2px; border-bottom-color: #00000046; padding-bottom: 24px;">
        <div class="mb-6 ml-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-3/12">
          <div class="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20"
            data-te-ripple-init data-te-ripple-color="light">
            <img src="https://quantumuniversity.edu.in/news-center/wp-content/uploads/2023/11/Country-Holidays-Travel-web.jpg" class="w-full" alt="Louvre" />
            <a href="#!">
              <div
        ...
        <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
          <h5 class="mb-3 text-lg font-bold">Country Holidays Travel India Pvt. Ltd Placement Drive for the students of Quantum University offering 5.5 LPA</h5>
          <div
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="mr-2 h-5 w-5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M5 3h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z"></path>
              <path stroke-linecap="round" stroke-linejoin="round" d="M17 10l4 4m0 0l-4 4m4-4H3"></path>
            </svg>
            
            Placement
          </div>
          <p class="mb-6 text-neutral-500 dark:text-neutral-300">
            <small>November 27, 2023
              </small>
          </p>
          <p class="text-neutral-500 dark:text-neutral-300">
            Country Holidays Inn and SuitesPvt. Ltd. is a travel company. It was established on December 21st, 2016 with the goal to provide budget travel packages to customers worldwide.
          </p>
        </div>
      </div>
      ...
      <div class="mb-6 flex flex-wrap" style="border-bottom-width: 2px; border-bottom-color: #00000046; padding-bottom: 24px;">
        <div class="mb-6 ml-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-3/12">
          <div class="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20"
            data-te-ripple-init data-te-ripple-color="light">
            <img src="https://quantumuniversity.edu.in/news-center/wp-content/uploads/2023/11/Keyideas-web.jpg" class="w-full" alt="Louvre" />
            <a href="#!">
              <div
                class="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100 bg-[hsla(0,0%,98.4%,.15)]">
              </div>
        ...
        <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
          <h5 class="mb-3 text-lg font-bold">Key Ideas Infotech Placement Drive for BBA, MBA & B.Com students offering 5 LPA Salary Package</h5>
          <div
          ...
          <p class="text-neutral-500 dark:text-neutral-300">
            Key ideas is a premier web design, mobile apps, and web development company with development offices in Gurgaon and a sales office in Florida USA.
          </p>
        </div>
      </div>
      ...
      <div class="mb-6 flex flex-wrap" >
        <div class="mb-6 ml-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-3/12 ">
          <div class="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20 "
            data-te-ripple-init data-te-ripple-color="light">
            <img src="https://quantumuniversity.edu.in/news-center/wp-content/uploads/2023/11/Ceasefire-web-1.jpg" class="w-full" alt="Louvre" />
            <a href="#!">
              <div
                class="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100 bg-[hsla(0,0%,98.4%,.15)]">
              </div>
        ...
        <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
          <h5 class="mb-3 text-lg font-bold">Congratulations!!! Q-Mates for getting placed at Cease-Fire with a 5.16 LPA Salary Package</h5>
          ...
          <p class="text-neutral-500 dark:text-neutral-300">
            Ceasefire Today is the most trusted fire safety brand in India and a fast-emerging global conglomerate. It is a leading manufacturer of a 360-degree unified product range that includes a complete line of Fire Extinguishers with -the widest variety of extinguishing agents, Special Application Extinguishers, Highly advanced In-Panel Suppression Systems, etc.
          </p>
        </div>
      </div>
    </section>
