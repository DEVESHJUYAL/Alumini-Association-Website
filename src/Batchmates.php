...
?>
    ...
    <div style="display: flex; justify-content: center; margin-top: 10px; margin-bottom: 10px;"><h1 class="text-3xl font-medium ">Search Your Batchmates</h1></div>
    
    <form style="display: flex; align-items: center; justify-content: center; margin-top: 20px;" class="search-container" onsubmit="event.preventDefault(); searchByYear();">   
        <label for="yearInput" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
        <div class="relative md:w-auto" style="margin-bottom: 20px; display: flex;">
            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
                </svg>
            </div>
            <input type="number" id="yearInput" class="block p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Year" required>
            <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
        </div>
    </form>
    

<div id="batch2024" class="container my-24 mx-auto md:px-6">
    <!-- Section: Design Block -->
    <section class="mb-32 text-center">
      <h2 class="mb-12 text-3xl font-bold">
        Meet the <u class="text-primary dark:text-primary-400">2024 Batchmates</u>
      </h2>
...
<div id="batch2023" class="container my-24 mx-auto md:px-6">
    <!-- Section: Design Block -->
    <section class="mb-32 text-center">
      <h2 class="mb-12 text-3xl font-bold">
        Meet the <u class="text-primary dark:text-primary-400">2023 Batchmates</u>
      </h2>
  ...
  <!-- Container for demo purpose -->
<div id="batch2022" class="container my-24 mx-auto md:px-6">
    <!-- Section: Design Block -->
    <section class="mb-32 text-center">
      <h2 class="mb-12 text-3xl font-bold">
        Meet the <u class="text-primary dark:text-primary-400">2022 Batchmates</u>
      </h2>
  ...
  <!-- Container for demo purpose -->
    ...
    <script>
      ...
      function searchByYear() {
            ...
            var allBatchSections = document.querySelectorAll('.container');
            allBatchSections.forEach(function (section) {
                section.style.display = 'none';
            });

            // Show the selected batch section
            var selectedBatchSection = document.getElementById("batch" + yearInput);
            if (selectedBatchSection) {
                selectedBatchSection.style.display = 'block';
            } else {
                alert("No information found for the selected year.");
            }
        }
    </script>
